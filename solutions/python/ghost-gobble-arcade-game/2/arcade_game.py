...
#So this is about the operations and, or, not
...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    """
# More easier to put it in one line instead of this:
...
# either u choose on showing the conditions that make the win not happen
