...
def get_rounds(number):
    ...
    liste =[number,number+1,number+2]
...
def concatenate_rounds(rounds_1, rounds_2):
    ...
    for card in rounds_1:
        new_list.append(card)
    for card in rounds_2:
        new_list.append(card)
...
def list_contains_round(rounds, number):
    ...
    return any(card==number for card in rounds)
...
def approx_average_is_average(hand):
    ...
    return card_average(hand) == approx or card_average(hand)==mid
